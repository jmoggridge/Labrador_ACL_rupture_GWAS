...
**Related publication**: 
Baker LA et al. 2017. Genome-wide association analysis in dogs implicates 99 loci as risk variants for anterior cruciate ligament rupture. *PLOS ONE* 12(4): e0173810. 
https://doi.org/10.1371/journal.pone.0173810
  
  **Data source**: Data dryad:  
https://datadryad.org/stash/dataset/doi:10.5061/dryad.8kk06   
(We'll download the data with `curl` in the tutorial)
...
Since an independent sample is assumed for association testing, we want to exclude any related individuals from analysis. 
...
# Order your data, from lowest to highest p-values
...
Permutation will take a few minutes. Once it has started, it's a good time to run some of the R code included with this tutorial to explore the data we have generated already. 


<!-- Reflection on your experience learning this analysis and what you think the most challenging parts -->
<!-- were. Describe why you chose this particular analysis. Please include details on how accessible and -->
<!-- well-documented your chosen workflow or software was, and what specific points might pose significant -->
<!-- challenges to others learning this type of analysis. (20%) -->


## 5 Discussion 

There are a number of complicated aspects in performing genome-wide association analyses. Many genetic and statistical concepts are involved and organism-specific knowledge is key. I found that setting parameters for pruning and selecting appropriate association tests was challenging. The dataset I chose for this tutorial (Baker *et al.,* 2017) had the benefit of being a nice size (n=237), though I could not reproduce their result as some data is missing from data dryad (*e.g.*. neutering). I found Plink easy to use after following the Marees tutorial. The documentation is adequate to operate the tool but the explanation is terse. I choose to perform a GWAS analysis for this work because I am interested in methods that allow us to unravel the genetic underpinnings of complex traits and diseases. Genome-wide association and quantiative trait loci both seem highly relevant as large-scale genomics work becomes more tractable, allowing personalized medicine, *etc.*, to be realized.
...
## Comparing with the permutation estimates
