...
The MDS results are in `cr237_filter6.mds`. You'll want to visualize these before moving on, so download the cr237_filter6.mds and .fam files and skip to the R section for MDS plotting. Check the results and return back to here afterwards.
